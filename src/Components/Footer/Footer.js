        ...
        <div>
            <section className="footer-container mt-5 px-3">
                <div className="subscribe d-flex justify-content-center">
                    <div>
                        <h2 className="mt-4 mr-5 text-center">Travel Tips & Special Offers</h2>
                ...
                <div className="row mt-4 mb-4 d-flex justify-content-around">
                    <div className="col-md-2 ml-1">
                        ...
                        <p> <small> <i className="fas fa-envelope-square"></i> travel.square@gmail.com </small> </p>
                        <p> <small>  <i className="fas fa-phone-square-alt"></i> (+88) 01758- 785521 </small> </p>
                ...
                <p className="text-center text-white mt-2 ">Copyright ©  Travel Square. All rights reserved. </p>
            </section>
        </div>
    );
};
